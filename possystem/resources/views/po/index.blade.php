        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <!-- /.card-header -->
                    <form action="{{ url('cetak-po') }}" method="post">
    ...
    if(e.which == 13){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                isi += '</td>'
                isi += '<td>';
                    isi += '<input type="number" class="price" name="harga_jual" value="'+data.data.harga_beli+'" disabled style="border:none; background-color:transparent"><input type="hidden" class="product_id" name="id" value="'+data.data.id+'">';
                isi += '</td>';
                isi += '<td>';
                    isi += '<input type="number" class="qty" name="qty[]" value="1">';
                isi += '</td>';
                isi += '<td class="text-center">';
                    isi += '<button id="delete" class="btn btn-xs btn-danger delete" data-name1="'+data.data.name_product+'" data-price="'+data.data.harga_beli+'" data-qty1="1" ><i class="fas fa-trash">delete</i></button>';
                isi += '</td>';
    ...
    $('body').on('click', '.select', function() {
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                isi += '</td>'
                isi += '<td>';
                    isi += '<input type="number" class="price" name="harga_jual" value="'+data.data.harga_beli+'" disabled style="border:none; background-color:transparent"><input type="hidden" class="product_id" name="product_id[]" value="'+data.data.id+'">';
                isi += '</td>';
                isi += '<td>';
                    isi += '<input type="number" class="qty" name="qty[]" value="1">';
                isi += '</td>';
